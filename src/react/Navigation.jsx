...
export function Navigation({ onContact }) {
  ...
  useEffect(() => {
    setScrollLock("navigation", open);
    return () => setScrollLock("navigation", false);
  }, [open]);
  ...
  useEffect(() => {
    ...
    const onKeyDown = (event) => {
      ...
      if (event.key === "Tab") {
        const controls = navRef.current?.querySelectorAll("a, button");
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          className="btn btn-white-outlined"
          type="button"
